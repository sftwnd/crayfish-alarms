...
public interface ITimeRangeFactoryConfig<M,R> {
    ...
    default @Nonnull ITimeRangeFactoryConfig<M,R> immutable() {
        return ImmutableTimeRangeFactoryConfig.fromConfig(this);
    }
